...
public enum DirectoryExceptionType implements BaseExceptionType {
    ...
    ALREADY_HAS_SAME_NAME(HttpStatus.BAD_REQUEST, "현재 디렉토리는 이미 그 이름을 가지고 있습니다."),
    CANNOT_CHANGE_ROOT_DIRECOTRY_NAME(HttpStatus.BAD_REQUEST, "루트 디렉토리의 이름은 바꿀 수 없습니다."),
